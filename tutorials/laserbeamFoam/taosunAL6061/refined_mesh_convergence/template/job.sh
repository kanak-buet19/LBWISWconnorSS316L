...
on_error()
{
    ...
    echo
    echo "ERROR: taosunAL6061 job failed"
...
if [ "${TAOSUN_JOB_IN_CONTAINER:-0}" = "1" ]; then
    runCaseInsideContainer
    exit 0
fi

echo "=== Tao Sun Al6061 HPC job ==="
