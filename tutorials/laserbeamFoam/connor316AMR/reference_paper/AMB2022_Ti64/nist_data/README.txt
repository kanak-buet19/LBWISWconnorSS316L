...
Files included in this publication:
  ...
  Al_Spot_AA_ASR_Results.csv
	This table includes measurement results for the Asynchronous Additive Manufacturing Benchmark Challenge (A-AMB2022-01). Descriptions of the specific challenge problems can be found at https://www.nist.gov/ambench/amb2022-01-benchmark-challenge-problems. All A-AMB2022-01 challenge data was obtained from experiments on solid aluminum with either a stationary ("Spot") or scanning ("Scan") laser. This table includes stationary laser data for the average absorption (AA) before keyhole and after a keyhole was formed when 501 W laser power was delivered. These values are averages of 3 seperate runs with the stadard deviation given. Also given is the standard deviation of the time-dependent absorption only during the keyhole regime. Lastly, the solidification rate, as measured from the vertical depth of the melt pool, is given which is the average of two measurements. 

  Al_Spot_TDA_Results.csv
	This table includes measurement results for the Asynchronous Additive Manufacturing Benchmark Challenge (A-AMB2022-01). Descriptions of the specific challenge problems can be found at https://www.nist.gov/ambench/amb2022-01-benchmark-challenge-problems. All A-AMB2022-01 challenge data was obtained from experiments on solid aluminum with either a stationary ("Spot") or scanning ("Scan") laser. This table includes stationary laser data for the time-dependent absorption (TDA). Column one is the time in seconds, column two is the measured laser power input in watts, column three is the measured absolute absorption in watts, and column four is the relative absorption given as a percent of the input laser power. Also given is the filename of the datafile for this experimental data. 

  Al_Spot_TDW_Results.csv
	This table includes measurement results for the Asynchronous Additive Manufacturing Benchmark Challenge (A-AMB2022-01). Descriptions of the specific challenge problems can be found at https://www.nist.gov/ambench/amb2022-01-benchmark-challenge-problems. All A-AMB2022-01 challenge data was obtained from experiments on solid aluminum with either a stationary ("Spot") or scanning ("Scan") laser. This table includes stationary laser data for the melt pool width as measured across the top of the original metal surface. The first column is time in 20 microsecond intervals and the second column is melt pool width in micrometers as measured from X-ray image analysis. 

  Al_Scan_AA_MWD_ASR_Results.csv
	This table includes measurement results for the Asynchronous Additive Manufacturing Benchmark Challenge (A-AMB2022-01). Descriptions of the specific challenge problems can be found at https://www.nist.gov/ambench/amb2022-01-benchmark-challenge-problems. All A-AMB2022-01 challenge data was obtained from experiments on solid aluminum with either a stationary ("Spot") or scanning ("Scan") laser. This table includes scanned laser data for the average absorption (AA) before keyhole and after a keyhole was formed when 473 W laser power was delivered. These values are averages of 3 seperate runs with the stadard deviation given. Also given is the standard deviation of the time-dependent absorption only during the keyhole regime. The maximum melt pool depth and width are provided as measured from high speed x-ray imaging and averaged from three repeated measurements. Lastly, the solidification rate, as measured from the vertical depth of the melt pool, is given, which is the average of three measurements. 

  Al_Scan_TDA_v2_Results.csv
	This table includes measurement results for the Asynchronous Additive Manufacturing Benchmark Challenge (A-AMB2022-01). Descriptions of the specific challenge problems can be found at https://www.nist.gov/ambench/amb2022-01-benchmark-challenge-problems. All A-AMB2022-01 challenge data was obtained from experiments on solid aluminum with either a stationary ("Spot") or scanning ("Scan") laser. This table includes scanned laser data for the time-dependent absorption (TDA). Column one is the time in seconds, column two is the measured laser power input in watts, column three is the measured absolute absorption in watts, and column four is the relative absorption given as a percent of the input laser power. Also given is the filename of the datafile for this experimental data. 
...
2.0.0 (this version)
  Includes description for AM-Bench challenge results. 
