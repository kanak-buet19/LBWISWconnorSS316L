...
# CW single-track 316L bareplate calibration case.
# P=200W, v=1200mm/s, d_laser=0.05mm. Target: depth~74um, width~95um.
# 32um base mesh, 2-level AMR -> 8um. Track length 1.0mm, endTime 1.3ms.
# OpenFOAM 2506 inside Apptainer; post-processing Python on host conda (isw_env).
#
# Submit:  sbatch job.sh
# Allocates 4 tasks; solver ranks are set by system/decomposeParDict.
